...
template <class Scalar, bool enableThermal, class ParasContainer, class Container>
...
{
public:
    using IsothermalPvt = GasPvtMultiplexer<Scalar, /*enableThermal=*/false, std::nullptr_t, std::nullptr_t>;
