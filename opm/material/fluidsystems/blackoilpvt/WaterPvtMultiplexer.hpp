...
namespace gpuistl{
    //TODO: optimize order of template arguments
    template<class Scalar, class Params, class GPUContainer>
    WaterPvtMultiplexer<Scalar>
    copy_to_gpu(WaterPvtMultiplexer<Scalar>& cpuWaterPvt)
    {
        ...
        auto gpuRealPvt = copy_to_gpu<Params, GPUContainer, Scalar>(realPvt);
