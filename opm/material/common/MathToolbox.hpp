...
// template <class Evaluation>
// OPM_HOST_DEVICE typename MathToolbox<Evaluation>::Scalar getValue(const Evaluation& val)
// { return MathToolbox<Evaluation>::value(val); }

// template <class Evaluation>
// OPM_HOST_DEVICE typename MathToolbox<Evaluation>::Scalar scalarValue(const Evaluation& val)
// { return MathToolbox<Evaluation>::scalarValue(val); }

// // template <class Evaluation>
// // OPM_HOST_DEVICE typename Evaluation::ValueT getValue(const Evaluation& val)
// // { return MathToolbox<Evaluation>::value(val); }

// // template <class Evaluation>
// // OPM_HOST_DEVICE typename Evaluation::ValueT scalarValue(const Evaluation& val)
// // { return MathToolbox<Evaluation>::scalarValue(val); }
